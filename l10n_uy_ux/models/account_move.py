...
class AccountMove(models.Model):
    ...
    def _l10n_uy_edi_send(self):
        ...
        moves_to_send = self
        for move in self:
            if move.l10n_uy_edi_document_id and not move.l10n_uy_edi_document_id._can_edit():
                # Answered by DGI, or we ignore whether it got there: a second CFE must not be issued
                moves_to_send -= move
                continue
