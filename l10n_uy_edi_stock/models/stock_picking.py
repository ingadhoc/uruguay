...
class StockPicking(models.Model):
    ...
    def l10n_uy_edi_send_dgi(self):
        ...
        pre_validated_in_uruware = uy_delivery_guides.filtered(lambda x: x.l10n_uy_edi_cfe_uuid and not x.l10n_uy_edi_document_id.attachment_id and not x.l10n_uy_edi_cfe_state)
    ...
    def _get_l10n_latam_documents_domain(self):
        ...
        return [('code', 'in', codes), ('code', '!=', '0'),
                ('active', '=', True), ('internal_type', '=', 'stock_picking')]
    ...
    def _l10n_uy_stock_update_xml_and_pdf_file(self, response):
        ...
        # TODO KZ this should not be neceesary :(
